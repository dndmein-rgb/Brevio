    ...
    <div className="relative min-h-[50vh]">
      ...
      <div className="container px-8 py-16">
        <div className="flex flex-col items-center justify-center gap-8 text-center max-w-2xl mx-auto">
          ...
          <p className="text-lg leading-8 text-gray-600 border-2 border-rose-200 bg-white/50 backdrop-blur-xs rounded-lg border-dashed max-w-xl">
            You need to upgrade to the Basic Plan or the 
            Pro Plan to access this feature 💖
          </p>
          <Button asChild className="bg-linear-to-r from-rose-500 to-rose-700 hover:from-rose-600 hover:to-rose-800 text-white">
            ...
            View Pricing Plans <ArrowRight className='h-4 w-4' /></Link>
          </Button>
        </div>
      </div>
    </div>
