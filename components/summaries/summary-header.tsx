    ...
    <div className="flex gap-4 mb-4 justify-between items-center">
      <div className="space-y-6">
        <div className="flex flex-warp items-center gap-4">
          <Badge
            variant="secondary"
            className="relative px-4 py-1.5 text-sm dont-medium bg-white/80 backdrop-blur-xs rounded-full hover:bg-white/90 transition-all duration-200 shadow-xs  hover:shadow-md"
          >
