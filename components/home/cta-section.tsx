    ...
    <section className="bg-gray-50 py-12">
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-4"> {/* Added spacing between h2 and p */}
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
              Ready to Save Hours of Reading Time?
            </h2>
            <p className="mx-auto max-w-200 text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400 ">
          ...
          <div className="flex flex-col gap-2 min-[400px]:flex-row justify-center">
            {/* Added 'asChild' to handle the Link properly */}
            <Button 
              asChild
              size={'lg'}
              variant={'outline'} 
