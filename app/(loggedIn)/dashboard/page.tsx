...
export default async function DashboardPage() {
  ...
  if (!userId) return redirect("/sign");
        ...
        <div className="px-2 py-12 sm:py-24">
          <div className="flex gap-4 mb-8 justify-between items-center">
            ...
            {!hasReachedLimit && (
              <Button
                asChild
                className="bg-linear-to-r from-rose-500 to-rose-700 hover:from-rose-600 hover:to-rose-800 hover:scale-105 transition-all duration-300 group hover:no-underlinex"
              >
          ...
          {summaries.length === 0 ? (
            ...
            <div className="grid grid-cols-1 gap-4 sam:gap-6 md:grid-cols-2 lg:grid-cols-3 sm:px-0">
